...
//        var mBussiness = itemView.findViewById<TextView>(R.id.business)!!
//        var mCustomer = itemView.findViewById<TextView>(R.id.personal)!!
    ...
    override fun onBindViewHolder(holder: RecyclerViewHolder, position: Int) {
        ...
        var business = currentContact.name
        var customer = currentContact.number

        holder!!.mName.text = nameContact
        holder!!.mNumber.text = numberContact

//        holder!!.mBussiness.text = business
//        holder!!.mCustomer.text = customer
